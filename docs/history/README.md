...
- [`2026-09-14-verification-loop-closeout.md`](2026-09-14-verification-loop-closeout.md) — the session that turned `verify` on the repository itself and shipped 0.24.1: two verified findings fixed, the defect-lens rubric measured (two runs per arm) before it was adopted, two defects the measurement runs surfaced, and why rename-then-rm does not fix a stale-lock race.
