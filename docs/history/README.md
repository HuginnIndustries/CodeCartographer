...
- [`2026-09-15-self-audit-closeout.md`](2026-09-15-self-audit-closeout.md) — the session that split `core/broadside.ts`, ran the full deep-audit pipeline on the repository unattended through Pi (27 findings → issues #355–#372), and made CodeCartographer the subject of its own README and website.
